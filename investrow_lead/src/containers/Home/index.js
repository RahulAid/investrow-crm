...
export const Home = (props) => {
  ...
  const renderClosedLeads = (leads) => {
    let leadItem = [];
    for (let lead of leads) {
      if (lead.user_id === _id && lead.action === "Closed") {
        leadItem.push(
          ...
          <Row className="leads">
            ...
            <div className="flex justify-between max-w-[1300px]">
              <span
                ...
                className="cursor-pointer flex ml-7 mt-4 mb-0 items-center gap-1"
              >
              ...
              <Row className="cursor-pointer mb-3 flex gap-8 mt-10 ml-5">
                ...
                <Col className="col-1">
                  {searchInput && <input className="search-input"></input>}
                  <a
                    className="btn-sm"
                    variant="success"
                    type="btn"
